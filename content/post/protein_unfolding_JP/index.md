...
（簡単に説明できないものは、十分に理解できていない。）これはとても有名なアインシュタインの発言です。
...
さらに、タンパク質には生物学的に正しく機能するための重要な平衡状態がたくさんあり、フォールディング/アンフォールディングはその一つに過ぎません。

先に述べたような物理化学的性質に高いばらつきがある生物学的環境を見つけるのはそこまで難しいものではありません。
最もわかりやすい例は、細胞内の細胞質でしょう。
細胞内の非常に複雑で混雑した環境を知るためにも、理化学研究所による以下の動画を視聴することを強くお勧めします。

{{< youtube 2JU2LjPDrQY >}}

ビデオでも紹介されていましたが、私の研究では、様々な影響の下でタンパク質がどのように振る舞うかを理解することを目指しています。
この知識を活用することで、いつの日か、様々な条件下で働くタンパク質を設計する手法、さらには、細胞内のような非常に複雑な環境で働けるようにタンパク質を最適化するための手法を理解できるようになるかもしれません。
スーパーコンピュータを使って分子シミュレーションを実行することで、タンパク質化学の基礎科学を発展させるだけでなく、治療薬の設計や、人類のためになる各産業の目的に適う分子の設計に私の研究が役立つことを願っています。
